...
<body>
    ...
    <nav>
        ...
        <a href="index.php" class="cta-button">Login / Register</a>
    ...
    <section class="events" id="events">
                ...
                <?php while ($event = $events_result->fetch_assoc()): ?>
                    <div class="event-card">
                        ...
                        <div class="event-content">
                            ...
                            <a href="index.php" class="event-link">
                                Register Now
                                <i data-lucide="arrow-right"></i>
                            </a>
                        </div>
        ...
        <div style="text-align: center; margin-top: 3rem;">
            <a href="index.php" class="primary-btn">View All Events</a>
        </div>
    </section>
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <p>
                    ...
                    <a href="index.php" style="color: rgba(255,255,255,0.7); text-decoration: none;">Login</a>
                </p>
            </div>
            <div class="footer-section">
                <h3>Contact Us</h3>
